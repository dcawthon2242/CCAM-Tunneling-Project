...
[dcawthon2242/parachute-changeup](https://github.com/dcawthon2242/parachute-changeup),
not in this one; script names below link there.
...
1. **A real eye point.** Left- and right-handed hitter eye positions were
   ...
   ([`obm_eye_point.py`](https://github.com/dcawthon2242/parachute-changeup/blob/main/baseball/obm_eye_point.py)), registered into Statcast's frame (feet,
   origin at the back tip of home plate), then adjusted per MLB batter for
   listed height ([`obm_hitter_eye_points.py`](https://github.com/dcawthon2242/parachute-changeup/blob/main/baseball/obm_hitter_eye_points.py)). Eye height tracks
...
![Eye geometry](images/angtun_fig0_geometry.png)
...
- **The eye-level metric is a sharper chase predictor.** Same effect size per
  ...
  location ([`angular_tunnel_chase_robust.R`](https://github.com/dcawthon2242/parachute-changeup/blob/main/baseball/angular_tunnel_chase_robust.R), [`angular_tunnel_two_strike.R`](https://github.com/dcawthon2242/parachute-changeup/blob/main/baseball/angular_tunnel_two_strike.R)).
...
![Chase effect](images/angtun_fig4_chase_effect.png)
...
`data/statcast_model/` in the companion repo (the RDS files are not committed). Restating one SD of eye-level tunnel in mph and inches
of separation is in [`angular_tunnel_tangible.R`](https://github.com/dcawthon2242/parachute-changeup/blob/main/baseball/angular_tunnel_tangible.R).
...
rubber-position pipeline ([`baseball/rubber_*`](https://github.com/dcawthon2242/parachute-changeup/blob/main/baseball)) is the first half of that
tooling.
